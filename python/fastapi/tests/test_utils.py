...
from simplehook_fastapi.utils import (
    decode_body,
    encode_body,
...
class TestIsProduction:
    def test_true_when_fastapi_env_is_production(self) -> None:
        # Arrange
    ...
    def test_true_when_env_is_production(self) -> None:
        # Arrange
    ...
    def test_false_when_env_is_not_production(self) -> None:
        # Arrange
        os.environ.pop("FASTAPI_ENV", None)
